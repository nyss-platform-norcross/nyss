    ...
    public class ProjectHealthRiskData
    {
        ...
        public static (List<AlertRule>, List<HealthRisk>, List<ProjectHealthRisk>) Create()
        {
            var alertRules = new List<AlertRule>
            {
                ...
                {
                    Id = 1,
                    CountThreshold = AlertRuleCountThreshold1,
                ...
                {
                    Id = 2,
                    CountThreshold = AlertRuleCountThreshold2,
                    KilometersThreshold = AlertRuleKilometersThreshold,
                    DaysThreshold = AlertRuleDaysThreshold
                },
                new AlertRule
                {
                    Id = 3,
                    CountThreshold = AlertRuleCountThreshold0,
                    KilometersThreshold = AlertRuleKilometersThreshold,
                    DaysThreshold = AlertRuleDaysThreshold
                }
            };
