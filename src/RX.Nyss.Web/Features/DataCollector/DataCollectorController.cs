...
namespace RX.Nyss.Web.Features.DataCollector
{
    ...
    public class DataCollectorController : BaseController
    {
        ...
        [HttpGet, Route("dataCollector/{dataCollectorId}/get"), NeedsRole(Role.Administrator, Role.DataManager, Role.Supervisor)]
        ...
        [HttpGet, Route("project/{projectId:int}/dataCollector/list"), NeedsRole(Role.Administrator, Role.DataManager, Role.Supervisor), NeedsPolicy(Policy.NationalSocietyAccess)]
        ...
        [HttpPost, Route("project/{projectId:int}/dataCollector/create"), NeedsRole(Role.Administrator, Role.DataManager, Role.Supervisor), NeedsPolicy(Policy.NationalSocietyAccess)]
        ...
        [HttpPost, Route("dataCollector/{dataCollectorId:int}/edit"), NeedsRole(Role.Administrator, Role.DataManager, Role.Supervisor), NeedsPolicy(Policy.NationalSocietyAccess)]
        ...
        [HttpPost, Route("dataCollector/{dataCollectorId:int}/remove"), NeedsRole(Role.Administrator, Role.DataManager, Role.Supervisor), NeedsPolicy(Policy.NationalSocietyAccess)]
