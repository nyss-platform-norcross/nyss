...
namespace RX.Nyss.Web.Features.DataCollector
{
    ...
    public class DataCollectorController : BaseController
    {
        ...
        [HttpGet, Route("dataCollector/{dataCollectorId:int}/get"), NeedsRole(Role.Administrator, Role.Manager, Role.Supervisor), NeedsPolicy(Policy.DataCollectorAccess)]
        ...
        [HttpGet, Route("project/{projectId:int}/dataCollector/list"), NeedsRole(Role.Administrator, Role.Manager, Role.Supervisor)]
        ...
        [HttpPost, Route("project/{projectId:int}/dataCollector/create"), NeedsRole(Role.Administrator, Role.Manager, Role.Supervisor)]
        ...
        [HttpPost, Route("dataCollector/{dataCollectorId:int}/edit"), NeedsRole(Role.Administrator, Role.Manager, Role.Supervisor), NeedsPolicy(Policy.DataCollectorAccess)]
        ...
        [HttpPost, Route("dataCollector/{dataCollectorId:int}/remove"), NeedsRole(Role.Administrator, Role.Manager, Role.Supervisor), NeedsPolicy(Policy.DataCollectorAccess)]
        ...
        [HttpGet, Route("project/{projectId:int}/dataCollector/formData"), NeedsRole(Role.Administrator, Role.Manager, Role.Supervisor)]
        ...
        [HttpGet, Route("project/{projectId:int}/basicData"), NeedsRole(Role.Administrator, Role.Manager, Role.Supervisor)]
