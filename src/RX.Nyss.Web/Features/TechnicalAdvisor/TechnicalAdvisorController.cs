...
namespace RX.Nyss.Web.Features.TechnicalAdvisor
{
    ...
    public class TechnicalAdvisorController : BaseController
    {
        ...
        /// <returns></returns>
        [HttpPost("technicalAdvisor/create")]
        ...
        /// <returns></returns>
        [HttpGet("technicalAdvisor/{technicalAdvisorId:int}/get")]
        ...
        /// <returns></returns>
        [HttpPost("technicalAdvisor/{technicalAdvisorId:int}/edit")]
        [NeedsRole(Role.Administrator, Role.GlobalCoordinator, Role.Manager, Role.TechnicalAdvisor), NeedsPolicy(Policy.TechnicalAdvisorAccess)]
        ...
        /// <returns></returns>
        [HttpPost("technicalAdvisor/{technicalAdvisorId:int}/remove")]
