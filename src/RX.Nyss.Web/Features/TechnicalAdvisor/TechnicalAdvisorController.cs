...
namespace RX.Nyss.Web.Features.TechnicalAdvisor
{
    ...
    public class TechnicalAdvisorController : BaseController
    {
        ...
        [NeedsRole(Role.Administrator, Role.GlobalCoordinator, Role.Manager, Role.Manager), NeedsPolicy(Policy.NationalSocietyAccess)]
        ...
        [NeedsRole(Role.Administrator, Role.GlobalCoordinator, Role.Manager, Role.Manager), NeedsPolicy(Policy.TechnicalAdvisorAccess)]
