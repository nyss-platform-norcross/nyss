...
namespace RX.Nyss.Web.Features.TechnicalAdvisor
{
    ...
    public class TechnicalAdvisorController : BaseController
    {
        ...
        /// <returns></returns>
        [HttpPost("nationalSociety/{nationalSocietyId:int}/technicalAdvisor/create"), NeedsRole(Role.Administrator, Role.GlobalCoordinator, Role.Manager),
        ...
        /// <returns></returns>
        [HttpGet("nationalSociety/technicalAdvisor/{technicalAdvisorId:int}/get"), NeedsRole(Role.Administrator, Role.GlobalCoordinator, Role.Manager),
         NeedsPolicy(Policy.TechnicalAdvisorAccess)]
        ...
        /// <returns></returns>
        [HttpPost("nationalSociety/technicalAdvisor/{technicalAdvisorId:int}/edit"), NeedsRole(Role.Administrator, Role.GlobalCoordinator, Role.Manager),
         NeedsPolicy(Policy.TechnicalAdvisorAccess)]
        ...
        /// <returns></returns>
        [HttpPost("nationalSociety/technicalAdvisor/{technicalAdvisorId:int}/remove"), NeedsRole(Role.Administrator, Role.GlobalCoordinator, Role.Manager),
         NeedsPolicy(Policy.TechnicalAdvisorAccess)]
