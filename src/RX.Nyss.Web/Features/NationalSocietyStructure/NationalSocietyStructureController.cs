...
namespace RX.Nyss.Web.Features.NationalSocietyStructure
{
    ...
    public class NationalSocietyStructureController : BaseController
    {
        ...
        /// </summary>
        [Route("region/{regionId:int}/district/list"), HttpGet, NeedsRole( Role.Administrator, Role.Manager, Role.TechnicalAdvisor, Role.Supervisor)]
        ...
        /// </summary>
        [Route("district/{districtId:int}/village/list"), HttpGet, NeedsRole( Role.Administrator, Role.Manager, Role.TechnicalAdvisor, Role.Supervisor)]
        ...
        /// </summary>
        [Route("village/{villageId:int}/zone/list"), HttpGet, NeedsRole( Role.Administrator, Role.Manager, Role.TechnicalAdvisor, Role.Supervisor)]
