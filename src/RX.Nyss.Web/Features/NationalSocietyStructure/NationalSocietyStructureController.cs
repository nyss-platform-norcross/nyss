...
namespace RX.Nyss.Web.Features.NationalSocietyStructure
{
    ...
    public class NationalSocietyStructureController : BaseController
    {
        ...
        /// </summary>
        [Route("nationalSociety/{nationalSocietyId:int}/region/list"), HttpGet, NeedsRole(Role.GlobalCoordinator, Role.Administrator, Role.DataManager, Role.TechnicalAdvisor, Role.DataConsumer)]
        ...
        /// </summary>
        [Route("region/{regionId:int}/district/list"), HttpGet, NeedsRole(Role.GlobalCoordinator, Role.Administrator, Role.DataManager, Role.TechnicalAdvisor, Role.DataConsumer)]
        ...
        /// </summary>
        [Route("district/{districtId:int}/village/list"), HttpGet, NeedsRole(Role.GlobalCoordinator, Role.Administrator, Role.DataManager, Role.TechnicalAdvisor, Role.DataConsumer)]
        ...
        /// </summary>
        [Route("village/{villageId:int}/zone/list"), HttpGet, NeedsRole(Role.GlobalCoordinator, Role.Administrator, Role.DataManager, Role.TechnicalAdvisor, Role.DataConsumer)]
