...
namespace RX.Nyss.Web.Migrations
{
    public partial class ApplicationDbContext_AddRolesAndSystemAdministratorAccount : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("INSERT [dbo].[AspNetRoles] ([Id], [Name], [NormalizedName], [ConcurrencyStamp]) VALUES (N'f6afa341-af08-4b8a-a6fd-7ca33382a440', N'TechnicalAdvisor', N'TECHNICALADVISOR', N'0b5dddf5-5008-48b3-8c9d-1831a1b7149a')");
            migrationBuilder.Sql("INSERT [dbo].[AspNetRoles] ([Id], [Name], [NormalizedName], [ConcurrencyStamp]) VALUES (N'fb23c271-059a-4537-ae3e-7f9fd5b305c6', N'DataManager', N'DATAMANAGER', N'8d27b561-f2ad-47cf-bd3a-e614995fffce')");
            ...
            migrationBuilder.Sql("INSERT [dbo].[AspNetUserRoles] ([UserId], [RoleId]) VALUES (N'9c1071c1-fa69-432a-9cd0-2c4baa703a67', N'b0091a03-ffaf-44f4-ac70-df9fcd295457')");
        }

        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql("DELETE FROM [dbo].[AspNetRoles] WHERE [Id]='b0091a03-ffaf-44f4-ac70-df9fcd295457'");
            migrationBuilder.Sql("DELETE FROM [dbo].[AspNetRoles] WHERE [Id]='b583d8c9-3feb-4e08-834c-c604e7481fae'");
            migrationBuilder.Sql("DELETE FROM [dbo].[AspNetRoles] WHERE [Id]='cca2c07b-c90f-46d2-8413-1dc6ee51e63a'");
            migrationBuilder.Sql("DELETE FROM [dbo].[AspNetRoles] WHERE [Id]='cef5482a-383c-4eaa-a23f-16577fc8d34b'");
            migrationBuilder.Sql("DELETE FROM [dbo].[AspNetRoles] WHERE [Id]='f6afa341-af08-4b8a-a6fd-7ca33382a440'");
            migrationBuilder.Sql("DELETE FROM [dbo].[AspNetRoles] WHERE [Id]='fb23c271-059a-4537-ae3e-7f9fd5b305c6'");

            migrationBuilder.Sql("DELETE FROM [dbo].[AspNetUsers] WHERE [Id]='9c1071c1-fa69-432a-9cd0-2c4baa703a67'");

            migrationBuilder.Sql("DELETE FROM [dbo].[AspNetUserRoles] WHERE [UserId]='9c1071c1-fa69-432a-9cd0-2c4baa703a67' AND [RoleId]='b0091a03-ffaf-44f4-ac70-df9fcd295457'");
        }
    }
}
