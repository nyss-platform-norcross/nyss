...
export const openModule = {
  ...
  success: (path, parameters, breadcrumb, generalMenu, sideMenu, tabMenu, projectTabMenu, title) =>
    ({ type: actions.OPEN_MODULE.SUCCESS, path, parameters, breadcrumb, generalMenu, sideMenu, tabMenu, projectTabMenu, title }),
