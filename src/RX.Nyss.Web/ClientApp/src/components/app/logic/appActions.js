...
export const openModule = {
  ...
  success: (path, parameters, breadcrumb, topMenu, generalMenu, sideMenu, tabMenu, title) =>
    ({ type: actions.OPEN_MODULE.SUCCESS, path, parameters, breadcrumb, topMenu, generalMenu, sideMenu, tabMenu, title }),
