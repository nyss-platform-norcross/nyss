    ...
    <Table>
      <TableHead>
        <TableRow>
          ...
          <TableCell style={{ width: "18%", "minWidth": "250px" }}>{strings(stringKeys.reports.list.dataCollectorDisplayName)}</TableCell>
          <TableCell style={{ width: "11%" }}>{strings(stringKeys.reports.list.dataCollectorPhoneNumber)}</TableCell>
          <TableCell style={{ width: "3%" }}>{strings(stringKeys.reports.list.malesBelowFive)}</TableCell>
          <TableCell style={{ width: "3%" }}>{strings(stringKeys.reports.list.malesAtLeastFive)}</TableCell>
          <TableCell style={{ width: "3%" }}>{strings(stringKeys.reports.list.femalesBelowFive)}</TableCell>
          <TableCell style={{ width: "3%" }}>{strings(stringKeys.reports.list.femalesAtLeastFive)}</TableCell>
        </TableRow>
      </TableHead>
      <TableBody>
        {list.map(row => (
          <TableRow key={row.id} hover className={styles.clickableRow}>
            ...
            <TableCell>{row.healthRiskName}</TableCell>
