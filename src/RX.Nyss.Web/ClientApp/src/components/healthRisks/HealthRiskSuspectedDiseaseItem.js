import styles from './HealthRiskSuspectedDiseaseItem.module.scss';
...
export const HealthRiskSuspectedDiseaseItem = ({ form, suspectedDisease, healthRiskSuspectedDisease, rtl }) => {
  ...
  useMount(() => {
    form.addField(`healthRisk.${healthRisk.healthRiskId}.projectHealthRiskId` || '', healthRiskSuspectedDisease.id, [], healthRiskItemRef);
