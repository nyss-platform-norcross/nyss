...
export const openList = {
  ...
  failure: (error) => ({ type: OPEN_NATIONAL_SOCIETY_USERS_LIST.FAILURE, error })
};
...
export const openCreation = {
  ...
  failure: (error) => ({ type: OPEN_NATIONAL_SOCIETY_USER_CREATION.FAILURE, error })
};
...
export const create = {
  ...
  failure: (error) => ({ type: CREATE_NATIONAL_SOCIETY_USER.FAILURE, error, suppressPopup: true })
};
...
export const openEdition = {
  ...
  success: (data, organizations, modems, countryCode) => ({ type: OPEN_NATIONAL_SOCIETY_USER_EDITION.SUCCESS, data, organizations, modems, countryCode }),
...
export const edit = {
  ...
  failure: (error) => ({ type: EDIT_NATIONAL_SOCIETY_USER.FAILURE, error, suppressPopup: true })
};
...
export const remove = {
  ...
  failure: (id, error) => ({ type: REMOVE_NATIONAL_SOCIETY_USER.FAILURE, id, error })
};
