...
import {
  OPEN_PROJECT_DASHBOARD, GET_PROJECT_DASHBOARD_DATA, GET_PROJECT_DASHBOARD_REPORT_HEALTH_RISKS, GENERATE_PDF
...
export const getDashboardData = {
  ...
  success: (filters, summary, reportsGroupedByHealthRiskAndDate, reportsGroupedByFeaturesAndDate, reportsGroupedByVillageAndDate, reportsGroupedByFeatures, reportsGroupedByLocation, dataCollectionPointReports) =>
    ({ type: GET_PROJECT_DASHBOARD_DATA.SUCCESS, filters, summary, reportsGroupedByHealthRiskAndDate, reportsGroupedByFeaturesAndDate, reportsGroupedByVillageAndDate, reportsGroupedByFeatures, reportsGroupedByLocation, dataCollectionPointReports }),
...
export const generatePdf = {
  invoke: (containerElement) => ({ type: GENERATE_PDF.INVOKE, containerElement }),
