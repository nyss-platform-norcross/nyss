...
export const getDashboardData = {
  ...
  success: (filters, summary, reportsGroupedByDate, reportsGroupedByFeaturesAndDate, reportsGroupedByVillageAndDate, reportsGroupedByFeatures, reportsGroupedByLocation, dataCollectionPointReports) =>
    ({ type: GET_PROJECT_DASHBOARD_DATA.SUCCESS, filters, summary, reportsGroupedByDate, reportsGroupedByFeaturesAndDate, reportsGroupedByVillageAndDate, reportsGroupedByFeatures, reportsGroupedByLocation, dataCollectionPointReports }),
