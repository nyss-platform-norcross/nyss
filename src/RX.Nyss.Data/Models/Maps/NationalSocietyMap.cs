...
namespace RX.Nyss.Data.Models.Maps
{
    public class NationalSocietyMap : IEntityTypeConfiguration<NationalSociety>
    {
        public void Configure(EntityTypeBuilder<NationalSociety> builder)
        {
            ...
            builder.Property(ns => ns.StartDate)
                .IsRequired();

            builder.Property(ns => ns.IsArchived)
                .IsRequired();

            builder.Property(ns => ns.RegionCustomName)
                .HasMaxLength(100);

            builder.Property(ns => ns.DistrictCustomName)
                .HasMaxLength(100);

            builder.Property(ns => ns.VillageCustomName)
                .HasMaxLength(100);

            builder.Property(ns => ns.ZoneCustomName)
                .HasMaxLength(100);
            ...
            builder.HasMany(ns => ns.RawReports)
                .WithOne(rr => rr.NationalSociety)
                .OnDelete(DeleteBehavior.Restrict);

            builder.HasOne(ns => ns.DefaultOrganization)
                .WithMany()
