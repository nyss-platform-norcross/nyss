...
namespace RX.Nyss.Data.Models.Maps
{
    public class ReportMap : IEntityTypeConfiguration<Report>
    {
        public void Configure(EntityTypeBuilder<Report> builder)
        {
            ...
            builder.Property(x => x.EpiWeek)
                .IsRequired();

            builder.Property(x => x.EpiYear)
                .IsRequired()
            ...
            builder.Property(x => x.ReportGroupLabel)
                .IsRequired();

            builder.Property(x => x.ReportedCaseCount)
                .IsRequired();
            ...
            builder.OwnsOne(x => x.DataCollectionPointCase)
                .Property(x => x.DeathCount);
            builder.OwnsOne(x => x.DataCollectionPointCase)
                .Property(x => x.FromOtherVillagesCount);

            builder.HasOne(x => x.RawReport)
                .WithOne(x => x.Report)
                .HasForeignKey<RawReport>(x => x.ReportId)
